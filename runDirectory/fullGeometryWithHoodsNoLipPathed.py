...
caseDir = "/home/bm424/OpenFOAM/bm424-v2312/run/pinecone/salomeToOF/"
...
upper_spline = caseDir + "spline.txt"
with open(upper_spline, "r") as file:
    upper_lines = file.readlines()

lower_spline = caseDir + "offset_spline.txt"
...
geompy.ExportSTL(Fuse_lower, caseDir + "Fuse_lower.stl", True, 0.001, True)
...
inlet_step_1 = geompy.ImportSTEP(
    caseDir + "groupCreationStepFiles/inlet.step", False, True
)
outlet_step_1 = geompy.ImportSTEP(
    caseDir + "groupCreationStepFiles/outlet.step", False, True
)
free_surface_step_1 = geompy.ImportSTEP(
    caseDir + "groupCreationStepFiles/free_surface.step", False, True
)
...
try:
    wholeGeo.ExportSTL(caseDir + "stlGroupsNew/trap_surface.stl", 1, trap_surface_1)
    pass
except:
    print("ExportPartToSTL() failed. Invalid file name?")
try:
    wholeGeo.ExportSTL(caseDir + "stlGroupsNew/outlet.stl", 1, outlet_1)
    pass
except:
    print("ExportPartToSTL() failed. Invalid file name?")
try:
    wholeGeo.ExportSTL(caseDir + "stlGroupsNew/inlet.stl", 1, inlet_1)
    pass
except:
    print("ExportPartToSTL() failed. Invalid file name?")
# try:
...
#   print('ExportPartToSTL() failed. Invalid file name?')
try:
    wholeGeo.ExportSTL(caseDir + "stlGroupsNew/free_surface.stl", 1, free_surface_1)
    pass
except:
    print("ExportPartToSTL() failed. Invalid file name?")
...
try:
    wholeGeo.ExportSTL(caseDir + "stlGroupsNew/walls.stl", 1, allCut)
    pass
except:
    print("ExportPartToSTL() failed. Invalid file name?")
...
try:
    fullHood_1.ExportSTL(caseDir + "stlGroupsNew/fullHood.stl", 1)
    pass
except:
