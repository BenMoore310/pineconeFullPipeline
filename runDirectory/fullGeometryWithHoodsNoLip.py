...
lower_spline = (
    "/home/bm424/OpenFOAM/bm424-v2312/run/pinecone/salomeToOF/offset_spline.txt"
)
...
Fuse_upper = geompy.MakeFuseList(
    [
        revolution_upper_1,
        Translation_upper_1,
        Translation_upper_2,
        ...
        Translation_upper_8,
        Translation_upper_9,
        Translation_upper_10,
        Translation_upper_11,
        Translation_upper_12,
        Translation_upper_13,
        Translation_upper_14,
        Translation_upper_15,
    ],
    False,
    False,
)
...
Fuse_lower = geompy.MakeFuseList(
    [
        revolution_lower_1,
        Translation_lower_1,
        Translation_lower_2,
        ...
        Translation_lower_8,
        Translation_lower_9,
        Translation_lower_10,
        Translation_lower_11,
        Translation_lower_12,
        Translation_lower_13,
        Translation_lower_14,
        Translation_lower_15,
    ],
    False,
    False,
)
...
geompy.ExportSTL(
    Fuse_lower,
    "/home/bm424/OpenFOAM/bm424-v2312/run/pinecone/salomeToOF/Fuse_lower.stl",
    True,
    0.001,
    True,
)
...
one_plate_wire = geompy.MakeWire(
    [Line_33, plate_wire, Line_36, Line_37, Line_38], 1e-07
)
...
translation_1_vertex_top = geompy.SubShape(
    Translation_1, geompy.ShapeType["VERTEX"], [1]
)
translation_1_vertex_bottom = geompy.SubShape(
    Translation_1, geompy.ShapeType["VERTEX"], [0]
)
...
translation_2_vertex_top = geompy.SubShape(
    Translation_2, geompy.ShapeType["VERTEX"], [1]
)
translation_2_vertex_bottom = geompy.SubShape(
    Translation_2, geompy.ShapeType["VERTEX"], [0]
)
...
translation_3_vertex_top = geompy.SubShape(
    Translation_3, geompy.ShapeType["VERTEX"], [1]
)
translation_3_vertex_bottom = geompy.SubShape(
    Translation_3, geompy.ShapeType["VERTEX"], [0]
)
...
translation_4_vertex_top = geompy.SubShape(
    Translation_4, geompy.ShapeType["VERTEX"], [1]
)
translation_4_vertex_bottom = geompy.SubShape(
    Translation_4, geompy.ShapeType["VERTEX"], [0]
)
...
translation_5_vertex_top = geompy.SubShape(
    Translation_5, geompy.ShapeType["VERTEX"], [1]
)
translation_5_vertex_bottom = geompy.SubShape(
    Translation_5, geompy.ShapeType["VERTEX"], [0]
)
...
translation_6_vertex_top = geompy.SubShape(
    Translation_6, geompy.ShapeType["VERTEX"], [1]
)
translation_6_vertex_bottom = geompy.SubShape(
    Translation_6, geompy.ShapeType["VERTEX"], [0]
)
...
translation_7_vertex_top = geompy.SubShape(
    Translation_7, geompy.ShapeType["VERTEX"], [1]
)
translation_7_vertex_bottom = geompy.SubShape(
    Translation_7, geompy.ShapeType["VERTEX"], [0]
)
...
translation_8_vertex_top = geompy.SubShape(
    Translation_8, geompy.ShapeType["VERTEX"], [1]
)
translation_8_vertex_bottom = geompy.SubShape(
    Translation_8, geompy.ShapeType["VERTEX"], [0]
)
...
translation_9_vertex_top = geompy.SubShape(
    Translation_9, geompy.ShapeType["VERTEX"], [1]
)
translation_9_vertex_bottom = geompy.SubShape(
    Translation_9, geompy.ShapeType["VERTEX"], [0]
)
...
translation_10_vertex_top = geompy.SubShape(
    Translation_10, geompy.ShapeType["VERTEX"], [1]
)
translation_10_vertex_bottom = geompy.SubShape(
    Translation_10, geompy.ShapeType["VERTEX"], [0]
)
...
translation_11_vertex_top = geompy.SubShape(
    Translation_11, geompy.ShapeType["VERTEX"], [1]
)
translation_11_vertex_bottom = geompy.SubShape(
    Translation_11, geompy.ShapeType["VERTEX"], [0]
)
line_11a = geompy.MakeLineTwoPnt(
    translation_10_vertex_bottom, translation_11_vertex_top
)
# geompy.addToStudy(line_2a, 'line_1a')

Translation_12 = geompy.MakeTranslation(Translation_11, 0, -3, 0)

translation_12_vertex_top = geompy.SubShape(
    Translation_12, geompy.ShapeType["VERTEX"], [1]
)
translation_12_vertex_bottom = geompy.SubShape(
    Translation_12, geompy.ShapeType["VERTEX"], [0]
)
line_12a = geompy.MakeLineTwoPnt(
    translation_11_vertex_bottom, translation_12_vertex_top
)
# geompy.addToStudy(line_2a, 'line_1a')

Translation_13 = geompy.MakeTranslation(Translation_12, 0, -3, 0)

translation_13_vertex_top = geompy.SubShape(
    Translation_13, geompy.ShapeType["VERTEX"], [1]
)
translation_13_vertex_bottom = geompy.SubShape(
    Translation_13, geompy.ShapeType["VERTEX"], [0]
)
line_13a = geompy.MakeLineTwoPnt(
    translation_12_vertex_bottom, translation_13_vertex_top
)
# geompy.addToStudy(line_2a, 'line_1a')

Translation_14 = geompy.MakeTranslation(Translation_13, 0, -3, 0)

translation_14_vertex_top = geompy.SubShape(
    Translation_14, geompy.ShapeType["VERTEX"], [1]
)
translation_14_vertex_bottom = geompy.SubShape(
    Translation_14, geompy.ShapeType["VERTEX"], [0]
)
line_14a = geompy.MakeLineTwoPnt(
    translation_13_vertex_bottom, translation_14_vertex_top
)
# geompy.addToStudy(line_2a, 'line_1a')

Translation_15 = geompy.MakeTranslation(one_plate_wire_reduced, 0, -45, 0)

translation_15_vertex_top = geompy.SubShape(
    Translation_15, geompy.ShapeType["VERTEX"], [1]
)
translation_15_vertex_bottom = geompy.SubShape(
    Translation_15, geompy.ShapeType["VERTEX"], [0]
)
line_15a = geompy.MakeLineTwoPnt(
    translation_14_vertex_bottom, translation_15_vertex_top
)
...
[
    ...
    geomObj_291,
    geomObj_292,
] = geompy.ExtractShapes(geomObj_261, geompy.ShapeType["FACE"], True)
...
inlet_step_1 = geompy.ImportSTEP(
    "/home/bm424/OpenFOAM/bm424-v2312/run/pinecone/salomeToOF/groupCreationStepFiles/inlet.step",
    False,
    True,
)
outlet_step_1 = geompy.ImportSTEP(
    "/home/bm424/OpenFOAM/bm424-v2312/run/pinecone/salomeToOF/groupCreationStepFiles/outlet.step",
    False,
    True,
)
free_surface_step_1 = geompy.ImportSTEP(
    "/home/bm424/OpenFOAM/bm424-v2312/run/pinecone/salomeToOF/groupCreationStepFiles/free_surface.step",
    False,
    True,
)
...
NETGEN_2D_Parameters_1 = smesh.CreateHypothesisByAverageLength(
    "NETGEN_Parameters_2D", "NETGENEngine", 0.2, 0
)
NETGEN_1D_2D = smesh.CreateHypothesis("NETGEN_2D", "NETGENEngine")
# hyp_3.SetLength( 7.59276 ) ### not created Object
NETGEN_2D_Parameters_2 = smesh.CreateHypothesisByAverageLength(
    "NETGEN_Parameters_2D", "NETGENEngine", 7.59276, 0
)
NETGEN_2D_Parameters_3 = smesh.CreateHypothesisByAverageLength(
    "NETGEN_Parameters_2D", "NETGENEngine", 16.0292, 0
)
...
try:
    wholeGeo.ExportSTL(
        r"/home/bm424/OpenFOAM/bm424-v2312/run/pinecone/salomeToOF/stlGroupsNew/trap_surface.stl",
        1,
        trap_surface_1,
    )
    pass
...
try:
    wholeGeo.ExportSTL(
        r"/home/bm424/OpenFOAM/bm424-v2312/run/pinecone/salomeToOF/stlGroupsNew/outlet.stl",
        1,
        outlet_1,
    )
    pass
...
try:
    wholeGeo.ExportSTL(
        r"/home/bm424/OpenFOAM/bm424-v2312/run/pinecone/salomeToOF/stlGroupsNew/inlet.stl",
        1,
        inlet_1,
    )
    pass
...
try:
    wholeGeo.ExportSTL(
        r"/home/bm424/OpenFOAM/bm424-v2312/run/pinecone/salomeToOF/stlGroupsNew/free_surface.stl",
        1,
        free_surface_1,
    )
    pass
...
allCut = wholeGeo.GetMesh().CutListOfGroups(
    [walls_1], [trap_surface_1, outlet_1, inlet_1, free_surface_1], "allCut"
)
try:
    wholeGeo.ExportSTL(
        r"/home/bm424/OpenFOAM/bm424-v2312/run/pinecone/salomeToOF/stlGroupsNew/walls.stl",
        1,
        allCut,
    )
    pass
...
try:
    fullHood_1.ExportSTL(
        r"/home/bm424/OpenFOAM/bm424-v2312/run/pinecone/salomeToOF/stlGroupsNew/fullHood.stl",
        1,
    )
    pass
except:
