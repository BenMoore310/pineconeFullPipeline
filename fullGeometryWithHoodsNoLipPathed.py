...
inlet_step_1 = geompy.ImportSTEP(caseDir + "groupCreationStepFiles/inlet.step", False, True)
outlet_step_1 = geompy.ImportSTEP(caseDir + "groupCreationStepFiles/outlet.step", False, True)
free_surface_step_1 = geompy.ImportSTEP(caseDir + "groupCreationStepFiles/free_surface.step", False, True)
